...
func (r ASDFVersionReader) ReadSDKVersions(projectRootDir string) (*Version, *Version, error) {
	...
	flutterSDKVersion, err := NewVersion(versionStr, ASDFConfigVersionSource)
	if err != nil {
		return nil, nil, err
	}
